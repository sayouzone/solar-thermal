...
python scripts/run_georeferencing_gcp_free_gpu.py \
...
또는 환경변수::
    ...
    GEOREF_DISABLE_GPU=1 python scripts/run_georeferencing_gcp_free.py ...
...
from solar_thermal.georeferencing import run_pipeline_gcp_free
